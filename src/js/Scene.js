...
export default class Scene {
    ...
    constructor($scene) {
        ...
        this.$detailview = document.querySelectorAll('.detail-view')
4
    ...
    start() {
        ...
        this.tiles = Array.from(this.$tiles).map(($el, i) => new Tile($el, this, duration, shader))
